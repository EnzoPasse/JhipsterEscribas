...
import { LayoutConfig } from 'app/shared/config/layout.config';
import { MenuOptions } from 'app/shared/directives/menu.directive';
import { OffcanvasOptions } from 'app/shared/directives/offcanvas.directive';
...
export class SideBarComponent implements OnInit, AfterViewInit {
  ...
  sideBarConfig: SideBarConfig = new SideBarConfig().configs;
   ...
   */
  constructor(private router: Router, private render: Renderer2, private cdr: ChangeDetectorRef) {}
  ...
  ngOnInit() {
    ...
    const config = this.layoutConfig.configs;
    console.log(config);
